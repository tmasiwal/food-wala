      ...
      >
                ...
                <Box key={navItem.label}>
                  <Popover trigger={"hover"} placement={"bottom-start"}>
                    <PopoverTrigger>
                      <Link
                        to={navItem.to}
                        onClick={() => handleCategory(navItem.label)}
                      >
                        <Box
                          as="a"
        ...
        <Flex>
          {token ? (
            <Flex spacing={7}>
              <Menu>
                ...
                <MenuList alignItems={"center"} pos={"fixed"} right={"-50px"}>
                  ...
                  <Center>
                    <Avatar
                      size={{ base: "md", sm: "md", md: "xl", lg: "xl" }}
                      src={imgAvatar}
                    />
                  </Center>
                  <br />
            ...
            <Flex gap={"1rem"} alignItems={"center"} className="outerauth">
              <Link to="/login">
                <Button
                  color={"black"}
                  as={"a"}
          ...
          <Flex className="sidemenu">
            <Menu>
              ...
              <MenuList>
                ...
                <br />
                <Link to={"/signup"}>
                  <MenuItem className="authbtn">{"Sign Up"}</MenuItem>
                </Link>
                <Link to={"/login"}>
                  <MenuItem className="authbtn" bg={"#e45a05"}>
                    {"Sign In"}
                  </MenuItem>
                </Link>
              </MenuList>
